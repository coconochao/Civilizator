...
- [ ] **T-054** — Build-time: 1 second per delivered unit × (1 / productivity)

### Phase G — Facilities & spawned map resources

- [ ] **T-060** — Plantation/Farm/CattleFarm: spawn in own 2×2 once per cycle per tile rules
- [ ] **T-061** — Upgraded facilities: double spawn rate
- [ ] **T-062** — Quarry: no spawn; ore gathering rules (base vs upgraded rates vs depletion)
- [ ] **T-063** — Natural node depletion except quarry-supported ore (indefinite with rate rules)
